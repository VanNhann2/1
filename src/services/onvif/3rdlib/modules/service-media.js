...
OnvifServiceMedia.prototype.getStreamUri = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetStreamUri', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getVideoEncoderConfigurations = function(callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    let soap = this._createRequestSoap(soap_body)
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetVideoEncoderConfigurations', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getVideoEncoderConfiguration = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetVideoEncoderConfiguration', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getCompatibleVideoEncoderConfigurations = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetCompatibleVideoEncoderConfigurations', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getVideoEncoderConfigurationOptions = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetVideoEncoderConfigurationOptions', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getGuaranteedNumberOfVideoEncoderInstances = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetGuaranteedNumberOfVideoEncoderInstances', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getProfiles = function(callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    let soap = this._createRequestSoap(soap_body)
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetProfiles', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getProfile = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetProfile', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.createProfile = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'CreateProfile', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.deleteProfile = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'DeleteProfile', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getVideoSources = function(callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    let soap = this._createRequestSoap(soap_body)
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetVideoSources', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getVideoSourceConfiguration = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetVideoSourceConfiguration', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getVideoSourceConfigurations = function(callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    let soap = this._createRequestSoap(soap_body)
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetVideoSourceConfigurations', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.addVideoSourceConfiguration = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'AddVideoSourceConfiguration', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getCompatibleVideoSourceConfigurations = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetCompatibleVideoSourceConfigurations', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getVideoSourceConfigurationOptions = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetVideoSourceConfigurationOptions', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getMetadataConfiguration = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetMetadataConfiguration', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getMetadataConfigurations = function(callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    let soap = this._createRequestSoap(soap_body)
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetMetadataConfigurations', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.addMetadataConfiguration = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'AddMetadataConfiguration', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getCompatibleMetadataConfigurations = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetCompatibleMetadataConfigurations', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getMetadataConfigurationOptions = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetMetadataConfigurationOptions', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getAudioSources = function(callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    let soap = this._createRequestSoap(soap_body)
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetAudioSources', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getAudioSourceConfiguration = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetAudioSourceConfiguration', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getAudioSourceConfigurations = function(callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    let soap = this._createRequestSoap(soap_body)
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetAudioSourceConfigurations', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.addAudioSourceConfiguration = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'AddAudioSourceConfiguration', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getCompatibleAudioSourceConfigurations = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetCompatibleAudioSourceConfigurations', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getAudioSourceConfigurationOptions = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetAudioSourceConfigurationOptions', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getAudioEncoderConfiguration = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetAudioEncoderConfiguration', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getAudioEncoderConfigurations = function(callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    let soap = this._createRequestSoap(soap_body)
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetAudioEncoderConfigurations', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.addAudioEncoderConfiguration = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'AddAudioEncoderConfiguration', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getCompatibleAudioEncoderConfigurations = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetCompatibleAudioEncoderConfigurations', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getAudioEncoderConfigurationOptions = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetAudioEncoderConfigurationOptions', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.startMulticastStreaming = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'StartMulticastStreaming', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.stopMulticastStreaming = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'StopMulticastStreaming', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.getSnapshotUri = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetSnapshotUri', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
...
OnvifServiceMedia.prototype.setVideoEncoderConfiguration = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    ...
    soap_body += '<trt:Configuration token="' + params['$']['token'] + '">'
    soap_body += '<trt:Name>' + params['Name'] + '</trt:Name>'
    soap_body += '<trt:UseCount>' + params['UseCount'] + '</trt:UseCount>'
    soap_body += '<trt:Encoding>' + params['Encoding'] + '</trt:Encoding>'
    soap_body += '<trt:Resolution>'
    soap_body += '<trt:Width>' + params['Resolution']['Width'] + '</trt:Width>'
    soap_body += '<trt:Height>' + params['Resolution']['Height'] + '</trt:Height>'
    soap_body += '</trt:Resolution>'
    soap_body += '<trt:Quality>' + params['Quality'] + '</trt:Quality>'
    if (
      params['RateControl'] &&
      params['RateControl']['FrameRateLimit'] &&
      params['RateControl']['EncodingInterval'] &&
      params['RateControl']['BitrateLimit']
    ) {
      soap_body += '<trt:RateControl>'
      soap_body += '<trt:FrameRateLimit>' + params['RateControl']['FrameRateLimit'] + '</trt:FrameRateLimit>'
      soap_body += '<trt:EncodingInterval>' + params['RateControl']['EncodingInterval'] + '</trt:EncodingInterval>'
      soap_body += '<trt:BitrateLimit>' + params['RateControl']['BitrateLimit'] + '</trt:BitrateLimit>'
      soap_body += '</trt:RateControl>'
    }
    soap_body += '<trt:Multicast>'
    soap_body += '<trt:Address>'
    soap_body += '<trt:Type>' + params['Multicast']['Address']['Type'] + '</trt:Type>'
    if (params['Multicast']['Address']['IPv4Address']) {
      soap_body += '<trt:IPv4Address>' + params['Multicast']['Address']['IPv4Address'] + '</trt:IPv4Address>'
    }
    if (params['Multicast']['Address']['IPv6Address']) {
      soap_body += '<trt:IPv6Address>' + params['Multicast']['Address']['IPv6Address'] + '</trt:IPv6Address>'
    }
    soap_body += '</trt:Address>'
    soap_body += '<trt:Port>' + params['Multicast']['Port'] + '</trt:Port>'
    soap_body += '<trt:TTL>' + params['Multicast']['TTL'] + '</trt:TTL>'
    soap_body += '<trt:AutoStart>' + params['Multicast']['AutoStart'] + '</trt:AutoStart>'
    soap_body += '</trt:Multicast>'
    soap_body += '<trt:SessionTimeout>' + params['SessionTimeout'] + '</trt:SessionTimeout>'
    ...
    mOnvifSoap
      .requestCommand(this.oxaddr, 'SetVideoEncoderConfiguration', soap)
      .then(result => {
        resolve(result)
      })
      .catch(error => {
