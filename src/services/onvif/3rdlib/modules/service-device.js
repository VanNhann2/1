...
// Centic development
// get IP addresses of device

OnvifServiceDevice.prototype.getDPAddresses = function(callback) {
  let promise = new Promise((resolve, reject) => {
    let soap_body = '<tds:GetDPAddresses/>'
    let soap = this._createRequestSoap(soap_body)
    mOnvifSoap
      .requestCommand(this.oxaddr, 'GetDPAddresses', soap)
      .then((result) => {
        resolve(result)
      })
      .catch((error) => {
...
// set network interfaces of device
OnvifServiceDevice.prototype.setNetworkInterfaces = function(params, callback) {
  let promise = new Promise((resolve, reject) => {
    let err_msg = ''
    if ((err_msg = mOnvifSoap.isInvalidValue(params, 'object'))) {
      reject(new Error('The value of "params" was invalid: ' + err_msg))
    ...
    if ((err_msg = mOnvifSoap.isInvalidValue(params['InterfaceToken'], 'string'))) {
      reject(new Error('The "InterfaceToken" property was invalid: ' + err_msg))
      return
    }

    if ((err_msg = mOnvifSoap.isInvalidValue(params['NetworkInterface'], 'object'))) {
      reject(new Error('The "NetworkInterface" property was invalid: ' + err_msg))
      return
    }

    if ((err_msg = mOnvifSoap.isInvalidValue(params['NetworkInterface']['Enabled'], 'boolean'))) {
      reject(new Error('The "NetworkInterface Enabled" property was invalid: ' + err_msg))
      return
    }

    if ((err_msg = mOnvifSoap.isInvalidValue(params['NetworkInterface']['IPv4'], 'object'))) {
      reject(new Error('The "NetworkInterface IPv4" property was invalid: ' + err_msg))
      return
    }

    if ((err_msg = mOnvifSoap.isInvalidValue(params['NetworkInterface']['IPv4']['Enabled'], 'boolean'))) {
      reject(new Error('The "NetworkInterface IPv4 Enabled" property was invalid: ' + err_msg))
      return
    }

    if ((err_msg = mOnvifSoap.isInvalidValue(params['NetworkInterface']['IPv4']['Manual'], 'object'))) {
      reject(new Error('The "NetworkInterface IPv4 Manual" property was invalid: ' + err_msg))
      return
    }

    if ((err_msg = mOnvifSoap.isInvalidValue(params['NetworkInterface']['IPv4']['Manual']['Address'], 'string'))) {
      reject(new Error('The "NetworkInterface IPv4 Manual Address" property was invalid: ' + err_msg))
      return
    }

    if ((err_msg = mOnvifSoap.isInvalidValue(params['NetworkInterface']['IPv4']['Manual']['PrefixLength'], 'string'))) {
      reject(new Error('The "NetworkInterface IPv4 Manual Address" property was invalid: ' + err_msg))
      return
    }

    if ((err_msg = mOnvifSoap.isInvalidValue(params['NetworkInterface']['IPv4']['DHCP'], 'boolean'))) {
      reject(new Error('The "NetworkInterface IPv4 DHCP" property was invalid: ' + err_msg))
      return
    }
    ...
    // {
    // 	InterfaceToken : interface_configs.NetworkInterfaces['$'].token,
    // 	NetworkInterface : {
    // 		Enabled: interface_configs.NetworkInterfaces.Enabled,
    // 		IPv4: {
    // 			Enabled: true,
    // 			Manual: {
    // 				Address: ipaddress,
    // 				PrefixLength: interface_configs.NetworkInterfaces.IPv4.Config.Manual.PrefixLength
    // 			},
    // 			DHCP: false
    // 		}
    // 	}
    ...
    soap_body += '<tds:SetNetworkInterfaces>'
    soap_body += '<tds:InterfaceToken>' + params['InterfaceToken'] + '</tds:InterfaceToken>'
    soap_body += '<tds:NetworkInterface>'
    soap_body += '<tds:Enabled>' + params['NetworkInterface']['Enabled'] + '</tds:Enabled>'
    soap_body += '<tds:IPv4>'
    soap_body += '<tds:Enabled>' + params['NetworkInterface']['IPv4']['Enabled'] + '</tds:Enabled>'
    soap_body += '<tds:Manual>'
    soap_body += '<tds:Address>' + params['NetworkInterface']['IPv4']['Manual']['Address'] + '</tds:Address>'
    soap_body += '<tds:PrefixLength>' + params['NetworkInterface']['IPv4']['Manual']['PrefixLength'] + '</tds:PrefixLength>'
    soap_body += '</tds:Manual>'
    soap_body += '<tds:DHCP>' + params['NetworkInterface']['IPv4']['DHCP'] + '</tds:DHCP>'
    soap_body += '</tds:IPv4>'
    soap_body += '</tds:NetworkInterface>'
    soap_body += '</tds:SetNetworkInterfaces>'
    ...
    let soap = this._createRequestSoap(soap_body)
    mOnvifSoap
      .requestCommand(this.oxaddr, 'SetNetworkInterfaces', soap)
      .then((result) => {
        resolve(result)
      })
      .catch((error) => {
